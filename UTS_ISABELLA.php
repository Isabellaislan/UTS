...
<body>
    ...
    <form method="POST" name="frmpost" action="">
        <table width="500" align="center" border="3" cellpadding="2" cellspacing="10">
            <tr align="center">
                <td>
                    <h2><b>Update Data Covid19 Terkini</b></h2>
                </td>
            </tr>
            <tr>
                <td>
                    <table width="450" border="0" cellpadding="0" cellspacing="10" align="center">
                        ...
                        <tr>
                            ...
                            <td><input type="submit"  value="Refresh" onClick="document.location.reload(true)"></td>
                        </tr>
                    </table>
                </td>
            </tr>
...
?>
    ...
    <?php if (isset($_POST['btnOk'])) {
        echo '<h3>Data Pemantauan Covid19 Wilayah ' . $_POST['wilayah'] . ' <br> Per '.date('d F Y H:i:s').' <br> '. $_POST['nama'] .' / '. $_POST['nim'] .' / '. getClientIP() .'</h3>';

       echo '<table border="5" cellpadding="10" cellspacing="2">';
        echo ' <thead>';
               echo '<tr>
